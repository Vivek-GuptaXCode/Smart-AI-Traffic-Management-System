...
class TrafficSignalEnv:
    ...
    def local_pressure(self) -> float:
        ...
        incoming_mean = _safe_mean(incoming)
        outgoing_mean = _safe_mean(outgoing)
    ...
    def _phase_queue_summary(
        ...
        current_queue = _safe_mean(queue_density[current_start:current_end])
        next_queue = _safe_mean(queue_density[next_start:next_end])
