...
class ForecastInferenceEngine:
    ...
    def __init__(
        ...
        elif self._feature_version in ("v3", "v3_lite"):
            from .feature_builder_v3_lite import FeatureStateV3Lite
            self.state_by_rsu: dict[str, Any] = {}
            self._FeatureStateClass = FeatureStateV3Lite
        else:
            self.state_by_rsu = {}
    ...
    def _build_features(self, payload: dict[str, Any]) -> np.ndarray:
        ...
        if self._feature_version in ("v3", "v3_lite"):
            from .feature_builder_v3_lite import build_inference_features_from_route_payload_v3_lite
            return build_inference_features_from_route_payload_v3_lite(payload, self.state_by_rsu)
